                ...
                <div class="option-group">
                    ...
                    <div class="keyboard-section">
                        ...
                        <div class="keyboard-group">
                            ...
                            <div class="shortcut-item">
                                <span class="shortcut-description">Analyze screen</span>
                                <div class="shortcut-keys">${this.formatKeybind(this.keybinds.analyzeScreen)}</div>
                            </div>
                            <div class="shortcut-item">
                                <span class="shortcut-description">Send transcription to AI</span>
                                <div class="shortcut-keys">${this.formatKeybind(this.keybinds.sendTranscription)}</div>
                            </div>
                            <div class="shortcut-item">
                                <span class="shortcut-description">Emergency erase (clear all data)</span>
